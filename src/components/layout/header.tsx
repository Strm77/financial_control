...
export function Header({ displayName }: { displayName: string }) {
  ...
  return (
    <header className="sticky top-0 z-20 bg-background/95 backdrop-blur border-b-[3px] border-b-border">
      <div className="flex items-center justify-between gap-3 px-4 sm:px-6 h-16">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="hidden sm:flex items-center gap-2 px-3 h-11 rounded-brutal border-brutal bg-card shadow-brutal-sm">
